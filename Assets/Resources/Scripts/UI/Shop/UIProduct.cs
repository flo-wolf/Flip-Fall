...
namespace FlipFall.UI
{
    ...
    public class UIProduct : MonoBehaviour
    {
        ...
        public void Start()
        {
            ProgressManager.GetProgress().unlocks.ReportUIProductsExistence(id, buyType);
            GetCorespondingProductInfo();
        ...
        public void UpdateToggles()
        {
            ...
            else if (buyType == BuyType.consumable)
            {
                buyButton.gameObject.SetActive(true);
                equipToggle.gameObject.SetActive(false);
            }
        ...
        public void Equip()
        {
            ...
            {
                if (productType == ProductType.theme && ProgressManager.GetProgress().unlocks.EquipProduct(id))
                {
        ...
        public class Product : FlipFall.Theme.Theme
        {
            public enum ProductType { theme, skin, supply }
            private ProductType productType;

            public FlipFall.Theme.Theme theme;
        }
    }
}